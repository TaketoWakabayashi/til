...
var CountryData = (function () {
    ...
    var basicCountryData = {
        ...
        TOKYO: { colorCode: 40, name: 'TOKYO', lat: 35.6, lon: 139.6 },
        OSAKA: { colorCode: 40, name: 'OSAKA', lat: 34.7, lon: 135.4 },
        HOKKAIDO: { colorCode: 40, name: 'HOKKAIDO', lat: 43.0, lon: 141.3 },
        OKINAWA: { colorCode: 40, name: 'OKINAWA', lat: 26.2, lon: 127.6 }
    };
