...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<mutant>.freeze, ["~> 0.11.4"])
    s.add_development_dependency(%q<mutant-rspec>.freeze, ["~> 0.11.4"])
    ...
    s.add_dependency(%q<mutant>.freeze, ["~> 0.11.4"])
    s.add_dependency(%q<mutant-rspec>.freeze, ["~> 0.11.4"])
